...
namespace DataReceiver.Services.Extentions
{
    ...
    public static class ConnectionFeatureExtensions
    {
        ...
        public static T? As<T>(this IConnection connection) where T : class
        {
            ...
            if (connection is DecoratorBase decorator) return decorator.Inner.As<T>();
        ...
        {
            while (connection is DecoratorBase decorator)
            {
        ...
        public static string Describe(this IConnection connection)
        {
            ...
            while (current is DecoratorBase decorator)
            {
